...
function ClientEdit({ user, handleLogout }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.fincapify.com/api/clients/${id}`, submissionData, {
                headers: getHeaders()
            });
    ...
    if (loading) return <p className="p-8 text-center text-sm text-slate-500">Loading client data...</p>;
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <main className="p-4 sm:p-6 lg:p-8 max-w-4xl w-full mx-auto space-y-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Dynamic Bank Accounts (Optional) */}
                        <div className="bg-white p-6 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.01)] border border-slate-100 space-y-4">
                        ...
                        <div className="flex gap-3 justify-end">
                            ...
                            <button type="submit" className="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-bold rounded-xl shadow-md transition-all duration-200 transform active:scale-95">Update Client</button>
